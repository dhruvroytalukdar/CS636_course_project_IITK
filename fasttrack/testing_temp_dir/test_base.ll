...
11:                                               ; preds = %8
  ...
  call void @__log_load(ptr %3), !dbg !335
  ...
  call void @__log_store(ptr %5), !dbg !334
  store i64 %16, ptr %5, align 8, !dbg !334
  call void @__log_load(ptr %5), !dbg !338
  %17 = load i64, ptr %5, align 8, !dbg !338
  %18 = add nsw i64 %17, 1, !dbg !339
  call void @__log_store(ptr %5), !dbg !340
  store i64 %18, ptr %5, align 8, !dbg !340
  call void @__log_load(ptr %5), !dbg !341
  %19 = load i64, ptr %5, align 8, !dbg !341
  call void @__log_load(ptr %3), !dbg !342
...
24:                                               ; preds = %11
  call void @__log_load(ptr %4), !dbg !347
  %25 = load i32, ptr %4, align 4, !dbg !347
  %26 = add nsw i32 %25, 1, !dbg !347
  call void @__log_store(ptr %4), !dbg !347
...
define dso_local noundef ptr @_Z13shared_workerPv(ptr noundef %0) #0 !dbg !353 {
  ...
  call void @__log_store(ptr %3), !dbg !358
  store i32 0, ptr %3, align 4, !dbg !358
  br label %5, !dbg !359

5:                                                ; preds = %13, %1
  call void @__log_load(ptr %3), !dbg !360
...
8:                                                ; preds = %5
  ...
  call void @__log_store(ptr %4), !dbg !366
  store i64 %9, ptr %4, align 8, !dbg !366
  call void @__log_load(ptr %4), !dbg !368
  %10 = load i64, ptr %4, align 8, !dbg !368
  %11 = add nsw i64 %10, 1, !dbg !369
  call void @__log_store(ptr %4), !dbg !370
  store i64 %11, ptr %4, align 8, !dbg !370
  call void @__log_load(ptr %4), !dbg !371
...
13:                                               ; preds = %8
  call void @__log_load(ptr %3), !dbg !374
  %14 = load i32, ptr %3, align 4, !dbg !374
  %15 = add nsw i32 %14, 1, !dbg !374
  call void @__log_store(ptr %3), !dbg !374
...
14:                                               ; preds = %11
  ...
  call void @__log_load(ptr %2), !dbg !408
  ...
  call void @__log_load(ptr %2), !dbg !410
...
39:                                               ; preds = %33
  call void @__log_load(ptr %2), !dbg !430
  %40 = load i32, ptr %2, align 4, !dbg !430
  %41 = add nsw i32 %40, 1, !dbg !430
  call void @__log_store(ptr %2), !dbg !430
...
47:                                               ; preds = %44
  ...
  call void @__log_load(ptr %2), !dbg !447
...
68:                                               ; preds = %62
  call void @__log_load(ptr %2), !dbg !467
  %69 = load i32, ptr %2, align 4, !dbg !467
  %70 = add nsw i32 %69, 1, !dbg !467
  call void @__log_store(ptr %2), !dbg !467
...
71:                                               ; preds = %59
  ...
  call void @__log_store(ptr %7), !dbg !472
  store i64 %72, ptr %7, align 8, !dbg !472
  call void @__log_load(ptr %7), !dbg !474
  %73 = load i64, ptr %7, align 8, !dbg !474
  call void @__log_load(ptr %5), !dbg !475
  ...
  call void @__log_load(ptr %6), !dbg !479
  %78 = load i64, ptr %6, align 8, !dbg !479
  call void @__log_load(ptr %5), !dbg !480
...
95:                                               ; preds = %87
  call void @__log_load(ptr %2), !dbg !499
  %96 = load i32, ptr %2, align 4, !dbg !499
  %97 = add nsw i32 %96, 1, !dbg !499
  call void @__log_store(ptr %2), !dbg !499
