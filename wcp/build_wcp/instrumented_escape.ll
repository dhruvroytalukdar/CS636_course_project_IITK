...
@private_chunks = dso_local global [8192 x i32] zeroinitializer, align 16, !dbg !0
@.str = private unnamed_addr constant [26 x i8] c"Fast path test complete.\0A\00", align 1, !dbg !8
@0 = private unnamed_addr constant [15 x i8] c"private_chunks\00", align 1
...
11:                                               ; preds = %29, %1
  ...
  %13 = icmp slt i32 %12, 1000, !dbg !47
...
18:                                               ; preds = %15
  ...
  %22 = getelementptr inbounds [8192 x i32], ptr @private_chunks, i64 0, i64 %21, !dbg !62
  call void @__wcp_read(ptr %22, i32 17, ptr @0), !dbg !63
  %23 = load i32, ptr %22, align 4, !dbg !63
  %24 = add nsw i32 %23, 1, !dbg !63
  call void @__wcp_write(ptr %22, i32 17, ptr @0), !dbg !63
...
5:                                                ; preds = %16, %0
  ...
  %7 = icmp slt i64 %6, 8, !dbg !93
  br i1 %7, label %8, label %19, !dbg !94

8:                                                ; preds = %5
  %9 = load i64, ptr %3, align 8, !dbg !95
  %10 = getelementptr inbounds [8 x i64], ptr %2, i64 0, i64 %9, !dbg !97
...
20:                                               ; preds = %29, %19
  ...
  %22 = icmp slt i32 %21, 8, !dbg !112
  br i1 %22, label %23, label %32, !dbg !113

23:                                               ; preds = %20
  %24 = load i32, ptr %4, align 4, !dbg !114
  %25 = sext i32 %24 to i64, !dbg !116
  %26 = getelementptr inbounds [8 x i64], ptr %2, i64 0, i64 %25, !dbg !116
  call void @__wcp_read(ptr %26, i32 29, ptr @1), !dbg !116
...
!3 = !DIFile(filename: "../benchmarks/targets/new_claude_benchmarks/test2.cpp", directory: "/mnt/c/Users/dhruv/Desktop/IIT-Kanpur/Sem 2/CS636/course_project/CS636_course_project_IITK/wcp", checksumkind: CSK_MD5, checksum: "9a611c2e1cebf207108d6c1ca701e57f")
!4 = !{!5, !6}
