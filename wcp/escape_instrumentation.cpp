<<<<<<< HEAD:wcp/escape_instrumentation.cpp
...
struct SharedPointerAnalysisPass : public PassInfoMixin<SharedPointerAnalysisPass> {
    ...
    //Dependency graph representing A -> B, if a shared/escaped then so is B 
    ...
    PreservedAnalyses run(Module &M, ModuleAnalysisManager &MAM) {
        ...
        // all global pointers into sharedset.
        ...
        for (Function &F : M) {
            for (BasicBlock &BB : F) {
                for (Instruction &I : BB) {
                    ...
                    //Put pointers passed to pthread_create into sharedset,
                    // this correct ??
        ...
        for (BasicBlock &BB : F) {
            for (Instruction &I : BB) {
                ...
                // 7. CALLS: Inter-procedural flow (TODO 5)
                    ...
                    //this is required since the analysis in intra function. the alias analysis only works in the function.
                    //so we have to handle the inter pointer flow from function to function. this was missed initially.
                    //
...
>>>>>>> f1e86c2 (wcp unique):escape_instrumentation.cpp
