...
131:                                              ; preds = %105, %73
  ...
  br i1 %139, label %140, label %161, !dbg !1438

140:                                              ; preds = %131, %152
  %141 = phi i64 [ %157, %152 ], [ 0, %131 ]
...
152:                                              ; preds = %144, %149
  ...
  %156 = call i32 @pthread_create(ptr noundef nonnull %155, ptr noundef null, ptr noundef nonnull @_Z9bs_threadPv, ptr noundef nonnull %142) #16, !dbg !1455
  %157 = add nuw nsw i64 %141, 1, !dbg !1456
    #dbg_value(i64 %157, !1250, !DIExpression(), !1274)
  %158 = load i32, ptr @nThreads, align 4, !dbg !1457, !tbaa !909
  %159 = sext i32 %158 to i64, !dbg !1437
  %160 = icmp slt i64 %157, %159, !dbg !1437
  br i1 %160, label %140, label %161, !dbg !1438, !llvm.loop !1458

161:                                              ; preds = %152, %131
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %3) #16, !dbg !1460
    #dbg_value(i32 0, !1269, !DIExpression(), !1273)
  br label %162, !dbg !1461

162:                                              ; preds = %161, %167
  %163 = phi i64 [ 0, %161 ], [ %169, %167 ]
    #dbg_value(i64 %163, !1269, !DIExpression(), !1273)
  %164 = getelementptr inbounds nuw [128 x i64], ptr @_M4_threadsTable, i64 0, i64 %163, !dbg !1463
  %165 = load i64, ptr %164, align 8, !dbg !1463, !tbaa !1364
  %166 = icmp eq i64 %165, -1, !dbg !1467
  br i1 %166, label %171, label %167, !dbg !1467

167:                                              ; preds = %162
  %168 = call i32 @pthread_join(i64 noundef %165, ptr noundef nonnull %3), !dbg !1468
  %169 = add nuw nsw i64 %163, 1, !dbg !1469
    #dbg_value(i64 %169, !1269, !DIExpression(), !1273)
  %170 = icmp eq i64 %169, 128, !dbg !1470
  br i1 %170, label %171, label %162, !dbg !1461, !llvm.loop !1471

171:                                              ; preds = %162, %167
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %3) #16, !dbg !1473
  %172 = call noalias ptr @fopen(ptr noundef %19, ptr noundef nonnull @.str.15), !dbg !1474
    #dbg_value(ptr %172, !1191, !DIExpression(), !1274)
  %173 = icmp eq ptr %172, null, !dbg !1475
  br i1 %173, label %174, label %176, !dbg !1475

174:                                              ; preds = %171
  %175 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, ptr noundef %19), !dbg !1477
  call void @exit(i32 noundef 1) #17, !dbg !1479
  unreachable, !dbg !1479

176:                                              ; preds = %171
  %177 = load i32, ptr @numOptions, align 4, !dbg !1480, !tbaa !909
  %178 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef nonnull %172, ptr noundef nonnull @.str.16, i32 noundef %177) #16, !dbg !1481
    #dbg_value(i32 %178, !1254, !DIExpression(), !1274)
  %179 = icmp slt i32 %178, 0, !dbg !1482
  br i1 %179, label %183, label %180, !dbg !1482

180:                                              ; preds = %176
    #dbg_value(i32 0, !1250, !DIExpression(), !1274)
  %181 = load i32, ptr @numOptions, align 4, !dbg !1484, !tbaa !909
  %182 = icmp sgt i32 %181, 0, !dbg !1487
  br i1 %182, label %191, label %202, !dbg !1488

183:                                              ; preds = %176
  %184 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.17, ptr noundef %19), !dbg !1489
  %185 = call i32 @fclose(ptr noundef nonnull %172), !dbg !1491
  call void @exit(i32 noundef 1) #17, !dbg !1492
  unreachable, !dbg !1492

186:                                              ; preds = %191
  %187 = add nuw nsw i64 %192, 1, !dbg !1493
    #dbg_value(i64 %187, !1250, !DIExpression(), !1274)
    #dbg_value(i64 %187, !1250, !DIExpression(), !1274)
  %188 = load i32, ptr @numOptions, align 4, !dbg !1484, !tbaa !909
  %189 = sext i32 %188 to i64, !dbg !1487
  %190 = icmp slt i64 %187, %189, !dbg !1487
  br i1 %190, label %191, label %202, !dbg !1488, !llvm.loop !1494

191:                                              ; preds = %180, %186
  %192 = phi i64 [ %187, %186 ], [ 0, %180 ]
    #dbg_value(i64 %192, !1250, !DIExpression(), !1274)
  %193 = load ptr, ptr @prices, align 8, !dbg !1496, !tbaa !1154
  %194 = getelementptr inbounds nuw float, ptr %193, i64 %192, !dbg !1496
  %195 = load float, ptr %194, align 4, !dbg !1496, !tbaa !1157
  %196 = fpext float %195 to double, !dbg !1496
  %197 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef nonnull %172, ptr noundef nonnull @.str.18, double noundef %196) #16, !dbg !1498
    #dbg_value(i32 %197, !1254, !DIExpression(), !1274)
  %198 = icmp slt i32 %197, 0, !dbg !1499
    #dbg_value(i64 %192, !1250, !DIExpression(DW_OP_plus_uconst, 1, DW_OP_stack_value), !1274)
  br i1 %198, label %199, label %186, !dbg !1499

199:                                              ; preds = %191
  %200 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.17, ptr noundef %19), !dbg !1501
  %201 = call i32 @fclose(ptr noundef nonnull %172), !dbg !1503
  call void @exit(i32 noundef 1) #17, !dbg !1504
  unreachable, !dbg !1504

202:                                              ; preds = %186, %180
  %203 = call i32 @fclose(ptr noundef nonnull %172), !dbg !1505
    #dbg_value(i32 %203, !1254, !DIExpression(), !1274)
  %204 = icmp eq i32 %203, 0, !dbg !1506
  br i1 %204, label %207, label %205, !dbg !1506

205:                                              ; preds = %202
  %206 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.11, ptr noundef %19), !dbg !1508
  call void @exit(i32 noundef 1) #17, !dbg !1510
  unreachable, !dbg !1510

207:                                              ; preds = %202
  %208 = load ptr, ptr @data, align 8, !dbg !1511, !tbaa !1320
  call void @free(ptr noundef %208) #16, !dbg !1512
  %209 = load ptr, ptr @prices, align 8, !dbg !1513, !tbaa !1154
  call void @free(ptr noundef %209) #16, !dbg !1514
  ret i32 0, !dbg !1515
}
...
!203 = !DICompositeType(tag: DW_TAG_structure_type, file: !197, line: 59, size: 64, flags: DIFlagFwdDecl, identifier: "_ZTS5div_t")
...
!1212 = !DICompositeType(tag: DW_TAG_structure_type, name: "_IO_marker", file: !1196, line: 38, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS10_IO_marker")
...
!1236 = !DICompositeType(tag: DW_TAG_structure_type, name: "_IO_codecvt", file: !1196, line: 39, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS11_IO_codecvt")
...
!1239 = !DICompositeType(tag: DW_TAG_structure_type, name: "_IO_wide_data", file: !1196, line: 40, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS13_IO_wide_data")
...
!1545 = !DICompositeType(tag: DW_TAG_union_type, name: "pthread_attr_t", file: !35, line: 56, size: 448, flags: DIFlagFwdDecl, identifier: "_ZTS14pthread_attr_t")
